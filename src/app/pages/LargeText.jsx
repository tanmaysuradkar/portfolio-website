...
const LargeText = (props) => {
  return (
    <div className="h-[170vh]   uppercase py-10  z-100 px-3 border-t-2 border-b-2 relative bg-black border-t-white border-b-white min-w-full text-white text-8xl sm:text-9xl font-bold">
