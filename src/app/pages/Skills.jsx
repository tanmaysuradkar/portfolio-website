...
const Skills = () => {
  return (
    <div className="h-screen z-20 relative bg-balck pb-20 w-full">
      <h1 className="text-6xl font-bold mb-3 text-white ">
        Things I'm good at{" "}
        <p className="text-xl pt-3">skills, interests, passion and hobbies</p>
      </h1>

      <div className="h-[90%] w-full relative flex justify-start items-center">
        <div className="h-full w-[70%]">
          <div className="h-[30%] mb-3.5 relative bg-white w-[98%] border-2 border-black p-5 ">
          ...
          <div className="h-[30%] bg-white mb-3 w-[98%] p-5 border-2 border-black ">
            <h1 className="text-black text-2xl capitalize font-medium">
              system design
            </h1>
            <div className="h-[62.3%] w-full grid grid-cols-3  lg:flex gap-1 lg:gap-1.5  relative">
        ...
        <div className="h-full w-[50%]  flex-wrap">
          <div className="h-[93.5%] lg:h-[95.9%] w-[100%] bg-white p-5 relative border-2 border-black ">
