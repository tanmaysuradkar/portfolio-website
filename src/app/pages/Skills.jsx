...
const Skills = () => {
  return (
    <div  className="h-screen pb-20 w-full p-5">
      ...
      <div className="h-[92%] w-[99%] p-2 relative flex justify-start items-center">
        <div className="h-full w-[60%]">
          <div className="h-[30%] mb-3 relative w-[98%] border-2 border-black p-5 ">
            ...
            <div className="h-[62.3%] w-full flex gap-1.5 relative">
              <div className="h-17 w-17 border-2 border-black flex justify-center items-center text-center rounded-sm overflow-hidden group  ">
              ...
              <div className="h-17 w-17 border-2  border-black rounded-sm overflow-hidden group flex justify-center items-center text-center ">
                <h1 className="bg-white cursor-pointer text-black font-medium border-2  hidden group-hover:flex px-1 rounded-sm border-black absolute ">
                  Postman
                </h1>
                <Image
        ...
        <div className="h-[99.7%] w-[30%] flex-wrap">
          <div className="h-[95%] mb-3 w-[98%] p-5 relative border-2 border-black ">
            <div className="h-[90%] relative w-[90%] flex flex-wrap items-end gap-1.5">
              <div className="h-17 w-17 border-2 flex-wrap flex justify-center items-center text-center border-black rounded-sm overflow-hidden group  ">
                <h1 className="bg-white cursor-pointer text-black font-medium border-2 hidden group-hover:flex px-1 rounded-sm border-black absolute">
                  TailwindCss
                </h1>
