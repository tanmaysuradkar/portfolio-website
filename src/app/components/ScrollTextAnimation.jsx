...
const ScrollTextAnimation = (props) => {
  ...
  return (
    ...
    <div  className="h-20 z-20 relative capitalize bg-black w-[350%] flex justify-start items-center border-t-2 overflow-x-hidden border-t-black">
      <props.motion.div
        animate={{
          x: `-${scrolls * 5}px`,
        }}
    ...
    <div className="h-20 z-20 -ml-96 relative capitalize w-[350%] flex justify-start items-center border-t-2 overflow-x-hidden  border-t-black">
      <props.motion.div
        animate={{
          x: `${scrolls * 5}px`,
        }}
    ...
    <div className="h-20 z-20 -ml-96 relative capitalize w-[350%] flex justify-start items-center border-b-2 border-t-2 overflow-x-hidden border-b-black  border-t-black">
      <props.motion.div
        animate={{
          x: `${scrolls * 5}px`,
        }}
