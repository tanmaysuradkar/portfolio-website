      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-10">
          ...
          <nav className="hidden md:flex justify-center text-center items-center space-x-25">
            ...
            <Link
              href="#"
              className="font-medium relative ms-10 font-general text-xl text-black uppercase after:absolute after:-bottom-0.5 after:left-0 after:h-[2px] after:w-full after:origin-bottom-right after:scale-x-0 after:bg-neutral-800 after:transition-transform after:duration-300 after:ease-[cubic-bezier(0.65_0.05_0.36_1)] hover:after:origin-bottom-left hover:after:scale-x-100 dark:after:bg-black cursor-pointer;"
            >
              Menu
            </Link>
          ...
          <div className="flex items-center space-x-4">
            <button className="group relative z-10 w-fit cursor-pointer overflow-hidden rounded-full bg-[#ffffff] px-7 py-0.5 border-2 text-black">
